---
layout: post
title:  听说有人想要做全套，那么今天它来了，保证让你的JVM不再寂寞-GC垃圾收集器&JVM调优汇总
tagline: by 揽月中人
categories: JVM GC
tags:
- 揽月中人
...
最近朋友小B说想一份GC优化的资料内容，JVM内存分析以及性能调优的时候方便查血。可是文章太多根本看不过来，那么今天指北君就为大家带来这份，GC垃圾收集器总结及其优化指南，让你的JVM从此不再寂寞。
...
![image-20210620144950996](E:\javaNorth\javanorth\assets\images\2021\lyj\jsonsoal.png)
...
![image-20210620152404975](E:\javaNorth\javanorth\assets\images\2021\lyj\VisuralVM2.0.7.png)

##### Memory Analyzer (MAT)

Eclipse 出品的一款Java堆内存分析程序，可以帮助我们找到内存泄漏和减少内存消耗。可在其官网下载，文末贴出下载地址

![image-20210620163203561](E:\javaNorth\javanorth\assets\images\2021\lyj\Eclipse-mat.png)
